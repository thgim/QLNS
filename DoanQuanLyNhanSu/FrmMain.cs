...
namespace DoanQuanlyNhanSu
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private DoanQuanlyNhanSu.Entities.NhanVienLogin nvlogin = null;
        ...
        private void AddNewTab(Form frm,int index,bool print=false) {
            ...
            foreach (TabPage tab in tabControl1.TabPages) {
                if ((int)tab.Tag == index) {
                    ...
                    MessageBox.Show("Đã được mở","Thông báo",MessageBoxButtons.OK,MessageBoxIcon.Stop);
                    return;
            ...
            lblCurrentTab.Text = tabitem.Text.Trim() + " hiện đang mở";
        ...
        private void SuccessLogin(DoanQuanlyNhanSu.Entities.NhanVienLogin nv) {
            this.nvlogin = nv;
            DangNhap(true);
            lblUserOnline.Text = "Người đăng nhập: " + nv.Ho + " " + nv.Ten+"(Quyền:"+(nv.LaAdmin?"Admin":"User")+")";
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                lblCurrentTab.Text = tabControl1.SelectedTab.Text.Trim() + " hiện đang mở";
        ...
        private void btnDangXuat_Click(object sender, EventArgs e)
        {
            ...
            OpenHomePage();
            DangNhap(false);
            lblUserOnline.Text = "Chưa đăng nhập";
        }
        ...
        private void lblUserOnline_Click(object sender, EventArgs e)
        {
