using DoanQuanlyNhanSu.Entities;
using System.Collections.Generic;
using System.Data.SqlClient;
using System;
namespace DoanQuanlyNhanSu.Models
{
    public class NhanVienModel:BaseModel<NhanVien>
    {
        ...
        public string insertNV(NhanVien entity)
        {
            ...
            if (MaHS != "") {
                entity.MaHS = MaHS;
                InsertNewRow(entity);
                lblMessage.Text = "Thêm thành công. Mật khẩu đăng nhập là 123";
            }
        ...
        public int ResetPass(string manv) {
            if (execute("update NHAN_VIEN set MAT_KHAU='123' where MANV='" + manv + "'",System.Data.CommandType.Text).resultNumber > 0) {
                return 1;
            }
            return -1;
        }
